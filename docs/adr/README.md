...
| [ADR-002](file:///C:/Users/ATLAB-USUARIO.DESKTOP-P2H460F/Documents/PROJECTS/Auto_Law-LiviaF/docs/adr/ADR-002-gateway-whatsapp-evolution-baileys.md) | Gateway WhatsApp — Evolution API (Modo Baileys) | **Aceito** | 2026-08-27 | Uso da **Evolution API v2 via QR Code (Baileys)** para eliminar burocracia e custos de mensageria na fase de homologação/operação inicial. |
...
| [ADR-004](file:///C:/Users/ATLAB-USUARIO.DESKTOP-P2H460F/Documents/PROJECTS/Auto_Law-LiviaF/docs/adr/ADR-004-persistencia-postgresql-database-isolada.md) | Persistência de Dados — PostgreSQL Único Multi-DB | **Aceito** | 2026-08-27 | Um **único container PostgreSQL 16** com 3 bases lógicas isoladas (`autolaw`, `langfuse`, `evolution_db`) para evitar conflito de schemas e economizar RAM. |
| [ADR-005](file:///C:/Users/ATLAB-USUARIO.DESKTOP-P2H460F/Documents/PROJECTS/Auto_Law-LiviaF/docs/adr/ADR-005-custo-zapsign-e-envio-via-evolution.md) | Integração ZapSign — Disparo de Link via Evolution | **Aceito** | 2026-08-27 | Configurar `send_automatic_whatsapp: false` no ZapSign e **enviar o link de assinatura pelo WhatsApp próprio via Evolution API**, economizando R$ 0,50/contrato. |
| [ADR-006](file:///C:/Users/ATLAB-USUARIO.DESKTOP-P2H460F/Documents/PROJECTS/Auto_Law-LiviaF/docs/adr/ADR-006-pipeline-incremental-e-tdd.md) | Metodologia — TDD e Docker Compose Incremental | **Aceito** | 2026-08-27 | Execução em **9 sprints incrementais orientados a testes (TDD)**, subindo os serviços de infraestrutura apenas no momento em que se tornam dependência. |
